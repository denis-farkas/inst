    ...
    <div className="main">
      ...
      <form onSubmit={handleSubmit}>
        <div className="inputGroup">
          <label className="inputLabel" id="title" htmlFor="title">
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="description" htmlFor="description">
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="date" htmlFor="date">
            Date
          </label>
          <input
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="hour" htmlFor="hour">
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="duration" htmlFor="duration">
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="price" htmlFor="price">
            Prix
          </label>
          <input
        ...
        <div className="inputGroup">
          <label className="inputLabel" id="personMax" htmlFor="personMax">
